...
class DefaultRealtime extends baserealtime_1.default {
    ...
    constructor(options) {
        ...
        super(defaults_1.default.objectifyOptions(options, true, 'Realtime', logger_1.default.defaultLogger, Object.assign(Object.assign({}, modularplugins_1.allCommonModularPlugins), { Crypto: (_a = DefaultRealtime.Crypto) !== null && _a !== void 0 ? _a : undefined, MsgPack, RealtimePresence: {
                ...
                presenceMessageFromValues: presencemessage_1.fromValues,
                presenceMessagesFromValuesArray: presencemessage_1.fromValuesArray,
...
class DefaultRest extends baserest_1.BaseRest {
    ...
    constructor(options) {
        ...
        super(defaults_1.default.objectifyOptions(options, true, 'Rest', logger_1.default.defaultLogger, Object.assign(Object.assign({}, modularplugins_1.allCommonModularPlugins), { Crypto: (_a = DefaultRest.Crypto) !== null && _a !== void 0 ? _a : undefined, MsgPack: (_b = DefaultRest._MsgPack) !== null && _b !== void 0 ? _b : undefined })));
    }
    static get Crypto() {
        if (this._Crypto === null) {
            throw new Error('Encryption not enabled; use ably.encryption.js instead');
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__(7582);
const protocolmessage_1 = tslib_1.__importStar(__webpack_require__(8294));
const eventemitter_1 = tslib_1.__importDefault(__webpack_require__(3388));
const Utils = tslib_1.__importStar(__webpack_require__(2678));
const logger_1 = tslib_1.__importDefault(__webpack_require__(1597));
    ...
    if (options && 'modes' in options) {
        ...
        for (let i = 0; i < options.modes.length; i++) {
            ...
            if (!currentMode ||
                ...
                !protocolmessage_1.channelModes.includes(String.prototype.toUpperCase.call(currentMode))) {
...
class RealtimeChannel extends eventemitter_1.default {
    ...
    async publish(...args) {
        ...
        if (argCount == 1) {
            if (Utils.isObject(messages))
                messages = [(0, message_1.fromValues)(messages)];
            else if (Array.isArray(messages))
                messages = (0, message_1.fromValuesArray)(messages);
            else
            ...
            messages = [(0, message_1.fromValues)({ name: args[0], data: args[1] })];
        }
        const maxMessageSize = this.client.options.maxMessageSize;
        await (0, message_1.encodeArray)(messages, this.channelOptions);
        /* RSL1i */
        const size = (0, message_1.getMessagesSize)(messages);
    ...
    _publish(messages, callback) {
        logger_1.default.logAction(this.logger, logger_1.default.LOG_MICRO, 'RealtimeChannel.publish()', 'message count = ' + messages.length);
        ...
        switch (state) {
            ...
            case 'suspended':
                ...
                break;
            default: {
                logger_1.default.logAction(this.logger, logger_1.default.LOG_MICRO, 'RealtimeChannel.publish()', 'sending message; channel state is ' + state);
                const msg = new protocolmessage_1.default();
                msg.action = protocolmessage_1.actions.MESSAGE;
    ...
    attachImpl() {
        ...
        const attachMsg = (0, protocolmessage_1.fromValues)({
            action: protocolmessage_1.actions.ATTACH,
            channel: this.name,
    ...
    detachImpl(callback) {
        ...
        const msg = (0, protocolmessage_1.fromValues)({ action: protocolmessage_1.actions.DETACH, channel: this.name });
    ...
    sync() {
        ...
        /* send sync request */
        const syncMessage = (0, protocolmessage_1.fromValues)({ action: protocolmessage_1.actions.SYNC, channel: this.name });
    ...
    sendPresence(presence, callback) {
        const msg = (0, protocolmessage_1.fromValues)({
            action: protocolmessage_1.actions.PRESENCE,
            channel: this.name,
    ...
    async processMessage(message) {
        if (message.action === protocolmessage_1.actions.ATTACHED ||
            message.action === protocolmessage_1.actions.MESSAGE ||
            message.action === protocolmessage_1.actions.PRESENCE) {
            // RTL15b
            this.setChannelSerial(message.channelSerial);
        }
        let syncChannelSerial, isSync = false;
        switch (message.action) {
            case protocolmessage_1.actions.ATTACHED: {
            ...
            case protocolmessage_1.actions.DETACHED: {
            ...
            case protocolmessage_1.actions.SYNC:
                ...
                if (!message.presence)
                    break;
            // eslint-disable-next-line no-fallthrough
            case protocolmessage_1.actions.PRESENCE: {
                ...
                for (let i = 0; i < presence.length; i++) {
                    try {
                        ...
                        await (0, presencemessage_1.decode)(presenceMsg, options);
                        ...
                        logger_1.default.logAction(this.logger, logger_1.default.LOG_ERROR, 'RealtimeChannel.processMessage()', e.toString());
                    }
                }
                if (this._presence) {
            ...
            case protocolmessage_1.actions.MESSAGE: {
                //RTL17
                if (this.state !== 'attached') {
                ...
                for (let i = 0; i < messages.length; i++) {
                    ...
                    try {
                        await (0, message_1.decode)(msg, this._decodingContext);
                    }
                    catch (e) {
            ...
            case protocolmessage_1.actions.ERROR: {
            ...
            default:
                logger_1.default.logAction(this.logger, logger_1.default.LOG_ERROR, 'RealtimeChannel.processMessage()', 'Fatal protocol error: unrecognised action (' + message.action + ')');
...
class RealtimePresence extends eventemitter_1.default {
    ...
    async _enterOrUpdateClient(id, clientId, data, action) {
        ...
        const presence = (0, presencemessage_1.fromData)(data);
        ...
        await (0, presencemessage_1.encode)(presence, channel.channelOptions);
        switch (channel.state) {
            case 'attached':
                return new Promise((resolve, reject) => {
        ...
        return new Promise((resolve, reject) => {
            switch (channel.state) {
                ...
                case 'failed': {
                    ...
                    const err = new errorinfo_1.PartialErrorInfo('Unable to leave presence channel (incompatible state)', 90001);
                    reject(err);
                    break;
                }
                default:
    ...
    setPresence(presenceSet, isSync, syncChannelSerial) {
        ...
        for (let i = 0; i < presenceSet.length; i++) {
            const presence = (0, presencemessage_1.fromValues)(presenceSet[i]);
    ...
    _ensureMyMembersPresent() {
        const myMembers = this._myMembers, reenterCb = (err) => {
            if (err) {
                ...
                const wrappedErr = new errorinfo_1.default(msg, 91004, 400);
                logger_1.default.logAction(this.logger, logger_1.default.LOG_ERROR, 'RealtimePresence._ensureMyMembersPresent()', msg);
    ...
    _synthesizeLeaves(items) {
        ...
        items.forEach(function (item) {
            const presence = (0, presencemessage_1.fromValues)({
                action: 'leave',
...
class PresenceMap extends eventemitter_1.default {
    ...
    put(item) {
        if (item.action === 'enter' || item.action === 'update') {
            item = (0, presencemessage_1.fromValues)(item);
            item.action = 'present';
        }
...
class RestChannel {
    ...
    async publish(...args) {
        ...
        if (typeof first === 'string' || first === null) {
            /* (name, data, ...) */
            messages = [(0, message_1.fromValues)({ name: first, data: second })];
            params = args[2];
        }
        else if (Utils.isObject(first)) {
            messages = [(0, message_1.fromValues)(first)];
            params = args[1];
        }
        else if (Array.isArray(first)) {
            messages = (0, message_1.fromValuesArray)(first);
            params = args[1];
        }
        else {
            throw new errorinfo_1.default('The single-argument form of publish() expects a message object or an array of message objects', 40013, 400);
        ...
        await (0, message_1.encodeArray)(messages, this.channelOptions);
        /* RSL1i */
        const size = (0, message_1.getMessagesSize)(messages), maxMessageSize = options.maxMessageSize;
        if (size > maxMessageSize) {
            throw new errorinfo_1.default('Maximum size of messages that can be published at once exceeded ( was ' +
                size +
                ' bytes; limit is ' +
        ...
        await this._publish((0, message_1.serialize)(messages, client._MsgPack, format), headers, params);
    }
...
class RestChannelMixin {
    ...
    static history(channel, params) {
        ...
        return new paginatedresource_1.default(client, this.basePath(channel) + '/messages', headers, envelope, async function (body, headers, unpacked) {
            return await (0, message_1.fromResponseBody)(body, options, channel.logger, client._MsgPack, unpacked ? undefined : format);
        }).get(params);
    }
...
class RestPresence {
    ...
    async get(params) {
        ...
        return new paginatedresource_1.default(client, this.channel.client.rest.presenceMixin.basePath(this), headers, envelope, async (body, headers, unpacked) => {
            return await (0, presencemessage_1.fromResponseBody)(body, options, this.logger, client._MsgPack, unpacked ? undefined : format);
        }).get(params);
    }
    async history(params) {
...
class RestPresenceMixin {
    ...
    static async history(presence, params) {
        ...
        return new paginatedresource_1.default(client, this.basePath(presence) + '/history', headers, envelope, async function (body, headers, unpacked) {
            return await (0, presencemessage_1.fromResponseBody)(body, options, presence.logger, client._MsgPack, unpacked ? undefined : format);
        }).get(params);
    }
}
...
function protocolMessageFromRawError(err) {
    ...
    if (shouldBeErrorAction(err)) {
        return [(0, protocolmessage_1.fromValues)({ action: protocolmessage_1.actions.ERROR, error: err })];
    }
    else {
        return [(0, protocolmessage_1.fromValues)({ action: protocolmessage_1.actions.DISCONNECTED, error: err })];
    }
}
/*
        ...
        try {
            ...
            if (items && items.length)
                for (let i = 0; i < items.length; i++)
                    this.onProtocolMessage((0, protocolmessage_1.fromDeserialized)(items[i], this.connectionManager.realtime._RealtimePresence));
        }
        catch (e) {
...
function bundleWith(dest, src, maxSize) {
    ...
    if ((action = dest.action) !== protocolmessage_1.actions.PRESENCE && action !== protocolmessage_1.actions.MESSAGE) {
    ...
    const kind = action === protocolmessage_1.actions.PRESENCE ? 'presence' : 'messages', proposed = dest[kind].concat(src[kind]), size = (0, message_1.getMessagesSize)(proposed);
    if (size > maxSize) {
        /* RTL6d1 */
        return false;
    }
...
class ConnectionManager extends eventemitter_1.default {
        ...
        switch (this.state.state) {
            case 'connected': {
                ...
                const authMsg = (0, protocolmessage_1.fromValues)({
                    action: protocolmessage_1.actions.AUTH,
                    auth: {
    ...
    send(msg, queueEvent, callback) {
        ...
        if (this.logger.shouldLog(logger_1.default.LOG_MICRO)) {
            logger_1.default.logAction(this.logger, logger_1.default.LOG_MICRO, 'ConnectionManager.send()', 'queueing msg; ' + (0, protocolmessage_1.stringify)(msg, this.realtime._RealtimePresence));
        }
    ...
    checkWsConnectivity() {
        const ws = new platform_1.default.Config.WebSocket(defaults_1.default.wsConnectivityUrl);
        return new Promise((resolve, reject) => {
            let finished = false;
            ws.onopen = () => {
                if (!finished) {
...
class PendingMessage {
    constructor(message, callback) {
        ...
        this.ackRequired = action == protocolmessage_1.actions.MESSAGE || action == protocolmessage_1.actions.PRESENCE;
    }
}
    ...
    send(pendingMessage) {
        ...
        if (this.logger.shouldLog(logger_1.default.LOG_MICRO)) {
            logger_1.default.logActionNoStrip(this.logger, logger_1.default.LOG_MICRO, 'Protocol.send()', 'sending msg; ' +
                (0, protocolmessage_1.stringify)(pendingMessage.message, this.transport.connectionManager.realtime._RealtimePresence));
        }
...
const errorinfo_1 = tslib_1.__importDefault(__webpack_require__(1798));
const platform_1 = tslib_1.__importDefault(__webpack_require__(7400));
const closeMessage = (0, protocolmessage_1.fromValues)({ action: protocolmessage_1.actions.CLOSE });
const disconnectMessage = (0, protocolmessage_1.fromValues)({ action: protocolmessage_1.actions.DISCONNECT });
/*
...
class Transport extends eventemitter_1.default {
    ...
    onProtocolMessage(message) {
        if (this.logger.shouldLog(logger_1.default.LOG_MICRO)) {
            logger_1.default.logActionNoStrip(this.logger, logger_1.default.LOG_MICRO, 'Transport.onProtocolMessage()', 'received on ' +
                this.shortName +
                ': ' +
                (0, protocolmessage_1.stringify)(message, this.connectionManager.realtime._RealtimePresence) +
                '; connectionId = ' +
                this.connectionManager.connectionId);
        }
        this.onActivity();
        switch (message.action) {
            case protocolmessage_1.actions.HEARTBEAT:
                ...
                break;
            case protocolmessage_1.actions.CONNECTED:
                this.onConnect(message);
                this.emit('connected', message.error, message.connectionId, message.connectionDetails, message);
                break;
            case protocolmessage_1.actions.CLOSED:
                this.onClose(message);
                break;
            case protocolmessage_1.actions.DISCONNECTED:
                this.onDisconnect(message);
                break;
            case protocolmessage_1.actions.ACK:
                this.emit('ack', message.msgSerial, message.count);
                break;
            case protocolmessage_1.actions.NACK:
                this.emit('nack', message.msgSerial, message.count, message.error);
                break;
            case protocolmessage_1.actions.SYNC:
                this.connectionManager.onChannelMessage(message, this);
                break;
            case protocolmessage_1.actions.ACTIVATE:
                // Ignored.
                break;
            case protocolmessage_1.actions.AUTH:
    ...
    ping(id) {
        const msg = { action: protocolmessage_1.actions.HEARTBEAT };
        if (id)
            msg.id = id;
...
class WebSocketTransport extends transport_1.default {
    ...
    onWsData(data) {
        ...
        try {
            this.onProtocolMessage((0, protocolmessage_1.deserialize)(data, this.connectionManager.realtime._MsgPack, this.connectionManager.realtime._RealtimePresence, this.format));
        }
        catch (e) {
...
class DefaultMessage extends message_1.default {
    ...
    static fromValues(values) {
        return Object.assign(new message_1.default(), values);
    }
    // Used by tests
    static async encode(msg, options) {
        return (0, message_1.encode)(msg, options);
    }
    // Used by tests
    static async decode(message, inputContext) {
        return (0, message_1.decode)(message, inputContext);
    }
}
...
class DefaultPresenceMessage extends presencemessage_1.default {
    static async fromEncoded(encoded, inputOptions) {
        return (0, presencemessage_1.fromEncoded)(logger_1.default.defaultLogger, encoded, inputOptions);
    }
    static async fromEncodedArray(encodedArray, options) {
        return (0, presencemessage_1.fromEncodedArray)(logger_1.default.defaultLogger, encodedArray, options);
    }
    static fromValues(values, stringifyAction) {
        return (0, presencemessage_1.fromValues)(values, stringifyAction);
    }
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getMessagesSize = exports.fromValuesArray = exports.fromValues = exports.fromResponseBody = exports.decode = exports.serialize = exports.encodeArray = exports.encode = exports.fromEncodedArray = exports.fromEncoded = void 0;
const tslib_1 = __webpack_require__(7582);
const platform_1 = tslib_1.__importDefault(__webpack_require__(7400));
const logger_1 = tslib_1.__importDefault(__webpack_require__(1597));
const errorinfo_1 = tslib_1.__importDefault(__webpack_require__(1798));
...
async function fromEncoded(logger, Crypto, encoded, inputOptions) {
    ...
    const options = normalizeCipherOptions(Crypto, logger, inputOptions !== null && inputOptions !== void 0 ? inputOptions : null);
    ...
    try {
        ...
        logger_1.default.logAction(logger, logger_1.default.LOG_ERROR, 'Message.fromEncoded()', e.toString());
    }
    return msg;
}
...
async function fromResponseBody(body, options, logger, MsgPack, format) {
    ...
    for (let i = 0; i < body.length; i++) {
        ...
        try {
            ...
            logger_1.default.logAction(logger, logger_1.default.LOG_ERROR, 'Message.fromResponseBody()', e.toString());
        }
    }
    return body;
}
exports.fromResponseBody = fromResponseBody;
...
exports.fromValuesArray = fromValuesArray;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getMessagesSize = exports.fromData = exports.fromValuesArray = exports.fromResponseBody = exports.decode = exports.encode = exports.fromValues = exports.fromEncodedArray = exports.fromEncoded = void 0;
const tslib_1 = __webpack_require__(7582);
const logger_1 = tslib_1.__importDefault(__webpack_require__(1597));
const platform_1 = tslib_1.__importDefault(__webpack_require__(7400));
const message_1 = __webpack_require__(3176);
Object.defineProperty(exports, "encode", ({ enumerable: true, get: function () { return message_1.encode; } }));
Object.defineProperty(exports, "getMessagesSize", ({ enumerable: true, get: function () { return message_1.getMessagesSize; } }));
const Utils = tslib_1.__importStar(__webpack_require__(2678));
...
async function fromEncoded(logger, encoded, options) {
    const msg = fromValues(encoded, true);
    /* if decoding fails at any point, catch and return the message decoded to
     * the fullest extent possible */
    try {
        await (0, exports.decode)(msg, options !== null && options !== void 0 ? options : {});
    }
    catch (e) {
        logger_1.default.logAction(logger, logger_1.default.LOG_ERROR, 'PresenceMessage.fromEncoded()', e.toString());
    }
    return msg;
}
exports.fromEncoded = fromEncoded;
...
exports.fromEncodedArray = fromEncodedArray;
function fromValues(values, stringifyAction) {
    if (stringifyAction) {
...
exports.fromValues = fromValues;
exports.decode = message_1.decode;
async function fromResponseBody(body, options, logger, MsgPack, format) {
    const messages = [];
    if (format) {
        body = Utils.decodeBody(body, MsgPack, format);
    ...
    for (let i = 0; i < body.length; i++) {
        ...
        try {
            await (0, exports.decode)(msg, options);
        }
        catch (e) {
            logger_1.default.logAction(logger, logger_1.default.LOG_ERROR, 'PresenceMessage.fromResponseBody()', e.toString());
        }
    }
    return messages;
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.stringify = exports.fromValues = exports.fromDeserializedIncludingDependencies = exports.fromDeserialized = exports.deserialize = exports.serialize = exports.channelModes = exports.ActionName = exports.actions = void 0;
const tslib_1 = __webpack_require__(7582);
const Utils = tslib_1.__importStar(__webpack_require__(2678));
const errorinfo_1 = tslib_1.__importDefault(__webpack_require__(1798));
const message_1 = __webpack_require__(3176);
...
exports.channelModes = ['PRESENCE', 'PUBLISH', 'SUBSCRIBE', 'PRESENCE_SUBSCRIBE'];
exports.serialize = Utils.encodeBody;
...
function fromDeserialized(deserialized, presenceMessagePlugin) {
    ...
    if (messages)
        for (let i = 0; i < messages.length; i++)
            messages[i] = (0, message_1.fromValues)(messages[i]);
    const presence = presenceMessagePlugin ? deserialized.presence : undefined;
    ...
    return Object.assign(new ProtocolMessage(), Object.assign(Object.assign({}, deserialized), { presence }));
}
...
function fromDeserializedIncludingDependencies(deserialized) {
    return fromDeserialized(deserialized, { presenceMessageFromValues: presencemessage_1.fromValues, presenceMessagesFromValuesArray: presencemessage_1.fromValuesArray });
}
...
function stringify(msg, presenceMessagePlugin) {
    ...
    if (msg.action !== undefined)
        result += '; action=' + exports.ActionName[msg.action] || 0;
    ...
    if (msg.messages)
        result += '; messages=' + toStringArray((0, message_1.fromValuesArray)(msg.messages));
...
class ProtocolMessage {
    ...
    decodeModesFromFlags() {
        const modes = [];
        exports.channelModes.forEach((mode) => {
