...
import { getInboxIdForAddress, generateInboxId, createClient } from '@xmtp/mls-client-bindings-node';
...
class Client {
    ...
    static async create(accountAddress, options) {
        ...
        return new Client(await createClient(host, isSecure, dbPath, inboxId, accountAddress, options?.encryptionKey), [new GroupUpdatedCodec(), new TextCodec(), ...(options?.codecs ?? [])]);
    }
    get accountAddress() {
